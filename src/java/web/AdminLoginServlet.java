...
public class AdminLoginServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        response.sendRedirect("home/admin/index.jsp");
    }
...
//        Users s = null;
        if (username.equals("pelskyadmin") && password.equals("57748tobi")) {
            //                PrintWriter out = response.getWriter();
//                out.println(s.getUsername());
        request.getSession().setAttribute("username", username);
        response.sendRedirect("home/admin/homepage.jsp");
        } 
        else {
            request.setAttribute("NOTIFICATION", "User not found");
            RequestDispatcher dispatch = request.getRequestDispatcher("home/admin/index.jsp");
