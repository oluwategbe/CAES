 ...
 * @author USER
 */
@WebServlet(name = "TechnicalServlet", urlPatterns = {"/technical"})
public class TechnicalServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet TechnicalServlet</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet TechnicalServlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
...
//        PrintWriter out = response.getWriter();
        ...
        int total = maths + english + physics + chemistry + td;
